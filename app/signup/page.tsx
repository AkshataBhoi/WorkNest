...
export default function SignUpPage() {
    ...
    return (
        <PageTransition>
            <div className="min-h-screen flex items-center justify-center bg-background selection:bg-primary/20 p-6">
                ...
                <div className="w-full max-w-md space-y-8">
                    <header className="text-center">
                        ...
                        <h2 className="text-3xl font-bold tracking-tight">Create your WorkNest account</h2>
                        <p className="text-muted-foreground mt-2">Get started in less than a minute.</p>
                    </header>
                    ...
                    <Card className="border-white/5 bg-card/50 backdrop-blur-xl shadow-2xl">
                        <CardContent className="pt-6 space-y-6">
                            <form onSubmit={handleSignUp} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="confirmPassword" className="text-sm font-medium text-muted-foreground ml-1">
                                        Confirm Password
                                    </label>
                                    <Input
                                        id="confirmPassword"
