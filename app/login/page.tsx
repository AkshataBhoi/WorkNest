  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-slate-950 selection:bg-violet-500/30 overflow-y-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden bg-slate-900/50 border-r border-white/5">
        ...
        <Link
          href="/"
          className="inline-block relative z-10 transition-transform hover:scale-105 active:scale-95"
        >
        ...
        <div className="relative z-10 space-y-10">
          <div className="space-y-6">
            ...
            <p className="text-xl text-slate-400 max-w-md leading-relaxed">
              WorkNest brings structure, collaboration, and clarity to teams
              across technology, operations, and finance.
            </p>
          </div>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    ...
                    disabled={loading}
                    variant="outline"
                    className="h-11 rounded-2xl border-white/5 bg-white/[0.02] hover:bg-white/[0.05] text-slate-400 text-xs font-bold"
                  >
                    Google
                  </Button>
                  <Button
