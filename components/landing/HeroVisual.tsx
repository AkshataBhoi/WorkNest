        ...
        <div className="relative h-[500px] w-full max-w-[600px] mx-auto lg:ml-auto">
            ...
            >
                ...
                <div>
                    ...
                    <div className="text-[10px] text-muted-foreground uppercase tracking-wider">Active Workspace</div>
                </div>
            </MotionDiv>
            ...
            >
                ...
                <div>
                    <div className="text-sm font-bold">New Project Launch</div>
                    <div className="text-[10px] text-muted-foreground uppercase tracking-wider">4 Team Members Added</div>
                </div>
            </MotionDiv>
            ...
            >
                ...
                <div>
                    <div className="text-sm font-bold text-amber-400">3 Pending Tasks</div>
            ...
            <MotionDiv
                ...
                className="absolute -bottom-8 left-12 p-4 rounded-xl border border-white/10 bg-card/80 backdrop-blur-xl shadow-xl z-20 flex items-center gap-3 w-48"
            >
                ...
                <div>
                    ...
                    <div className="text-[10px] text-muted-foreground uppercase tracking-wider">Shared Expenses</div>
                </div>
            </MotionDiv>
        </div>
    );
